...
public class PessoaVariasTabelas {
	...
	private static void persistePessoa() {
		try {
			...
			Pessoa1 p = new Pessoa1("9046131031", "Homem", "996772839",
					"Rua São Pedro, 06");
	...
	private static void persisteCliente() {
		try {
			...
			Cliente1 c = new Cliente1("1", "Procergs", "32184184",
	...
	private static void persisteAluno() {
		try {
			...
			Aluno1 a = new Aluno1("9415783054", "Senhor W", "99999999",
	...
	private static void persisteProfessor() {
		try {
			factory = Persistence.createEntityManagerFactory("jpa");
			EntityManager em = factory.createEntityManager();
			Professor1 pr = new Professor1("9046133063", "Cássio Trindade",
